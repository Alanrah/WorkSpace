...
(train_lbl, train_img) = read_data('mnist/input_data/train-labels-idx1-ubyte.gz','mnist/input_data/train-images-idx3-ubyte.gz') #构建训练数据
(val_lbl, val_img) = read_data('mnist/input_data/t10k-labels-idx1-ubyte.gz','mnist/input_data/t10k-images-idx3-ubyte.gz') #构建测试数据
